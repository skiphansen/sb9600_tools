...
#
# Updated and modified by W3AXL (https://github.com/W3AXL/python-radio-console)
#
...
class Serial:
    ...
    def sbep_enter(self):
        ...
        print("Got SBEP ACK msg: {}".format(msg))
        ack = self.ser.read(1)
        print("Got SBEP ACK: {}".format(ack))
    ...
    def sb9600_reset(self):
        ...
        """
        self.sb9600_send(sbep_modules["BCAST"], 0x00, 0x01, 0x08)